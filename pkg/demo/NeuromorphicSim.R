# options(cores = 2) # use this option to confiure the parallel computation (in this case 2 CPU cores are specified)
...
qplot(X1, value, data = melt(sdata), geom = "line") + facet_wrap(~ X2) + 
